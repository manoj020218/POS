...
export const resolveInventoryBalanceReport = async (
  ...
  const businessIds = resolveInventoryBusinessIds(accessibleBusinesses, query.businessId);
  ...
  const businessById = new Map(
    accessibleBusinesses.map((business) => [business.id, business] as const)
  );
...
export const resolveInventoryBusinessIds = (
